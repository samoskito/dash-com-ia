...
- Estado atual da ordem aprovada: **Bloco 0 implementado e em observacao de producao; Bloco 0.5 implementado localmente e aguardando deploy/configuracao MySQL/reconciliacao sombra; Bloco 1 - Visao Geral sera retomado depois da paridade com dados reais**.
...
9. Aprovar e implementar o conector externo: ledger append-only, cursor incremental, fuso do workspace, views sem token, workflows n8n corrigidos, caminho de rede seguro e cutover CAPI em modo sombra.
