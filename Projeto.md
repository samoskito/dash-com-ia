...
- Configuracoes agora tambem consome `GET /workspaces/current`, `GET /workspaces/current/members` e `GET /workspaces/current/invites`, exibindo nome/slug/papel do workspace, membros reais, convites pendentes e formulario de convite via `POST /workspaces/current/invites`, sem usuarios ficticios.
