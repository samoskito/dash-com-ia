...
- Configuracoes agora tambem consome `GET /workspaces/current` e `GET /workspaces/current/members`, exibindo nome/slug/papel do workspace, membros reais e formulario de convite via `POST /workspaces/current/invites`, sem usuarios ficticios.
