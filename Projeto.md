...
9. Publicar o corte CAPI por evento e aplicar `20260714020000_external_capi_event_cutover`. Em producao, assumir e validar um tipo por vez; desligar no n8n somente o node HTTP Meta correspondente depois da confirmacao do backoffice, mantendo os inserts do ledger ativos. Nao reenviar os eventos antigos classificados como `Em sombra` nem os `not_eligible`.
