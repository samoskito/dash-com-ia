...
9. Observar o gate CAPI da Barbieri em producao, tratando eventos `not_eligible` apenas como amostras nao enviaveis e corrigindo somente bloqueios reais. Aprovar os totais e ao menos uma amostra operacional valida dos tres eventos; somente depois desativar os envios Meta legados do n8n e habilitar o CAPI WppTrack em um corte controlado e reversivel.
