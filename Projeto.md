...
- Visao Geral e Relatorios agora diferenciam estados `real`, `empty` e `fallback`: resposta real vazia exibe estado vazio sem dados demo; falha de API exibe o fallback visual com tag explicita `Dados de demonstracao`.
...
- Overview/Reports agora mostram estado vazio real sem cair em mock e marcam fallback de API como `Dados de demonstracao`.

Proximo passo operacional:

- Continuar a proxima rodada com: polir selecao Meta BM/conta/pixel, reduzir fallbacks restantes em Leads/Integracoes/Configuracoes/Backoffice e evoluir relatorios por conjunto/anuncio.
