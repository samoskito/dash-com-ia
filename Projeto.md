...
- Ordem de trabalho aprovada em 2026-07-12: primeiro estabilizar Relatorios Meta; em seguida tratar Leads historicos nao resolvidos. Na proxima frente, `QualifiedLead`/`Purchase` recebidos sem conseguir cruzar com um lead de origem conhecido nao devem aparecer para o cliente nem contaminar indicadores; a regra precisa preservar auditoria da ingestao sem promover o registro para a experiencia operacional. Nao misturar esse gate de leads com a correcao de Insights.
