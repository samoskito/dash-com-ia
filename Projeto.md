...
- Continuar a proxima rodada com: criar endpoint e UI segura para salvar/limpar o token CAPI por workspace, substituir os ultimos placeholders operacionais por endpoints reais, validar a sincronizacao em uma conta Meta real e preparar os proximos conectores operacionais que ainda estao somente documentados.
